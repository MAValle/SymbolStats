...
Also we can compute variations taking values between $L$ periods and taking overlaps.
...
The result is a vector with all returns of three days of the SP500 with NO overlapping.
